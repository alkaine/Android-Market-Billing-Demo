...
package com.chugulu.dungeons;

import com.chugulu.dungeons.BillingService.RequestPurchase;
import com.chugulu.dungeons.BillingService.RestoreTransactions;
import com.chugulu.dungeons.Consts.PurchaseState;
import com.chugulu.dungeons.Consts.ResponseCode;
...
public class Dungeons extends Activity implements OnClickListener,
	...
	private Button mListInAppButton;
    ...
    private static final CatalogEntry[] CATALOG = new CatalogEntry[] {
        new CatalogEntry("sword_003", R.string.two_handed_sword, Managed.MANAGED),
		new CatalogEntry("sword_004", R.string.two_handed_sword_unknown, Managed.MANAGED),
...
getString(LOG_TEXT_KEY)));
    ...
    private void setupWidgets() {
        ...
        mListInAppButton = (Button) findViewById(R.id.list_in_app_button);
		mListInAppButton.setOnClickListener(this);
